...
curl -LO https://github.com/Lebenoa/fefix/releases/latest/download/fefix-26.09.2-x86_64-linux.tar.xz
tar xJf fefix-26.09.2-x86_64-linux.tar.xz
cd fefix-26.09.2-x86_64-linux
...
```sh
sudo dpkg -i fefix-v26.09.2-x86_64-linux.deb   # if named helix_26.09.2-1_amd64.deb
```

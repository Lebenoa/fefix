...
directory (default `~/.config/fefix` on Linux systems) with a structure like
this:
...
C-o = ":open ~/.config/fefix/config.toml" # Maps Ctrl-o to opening of the fefix config file

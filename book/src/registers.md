...
In fefix, registers are storage locations for text and other data, such as the
...
fefix allows you to create your own named registers for storing text, for
example:
...
selections if the clipboard was last yanked to by the fefix session. Otherwise

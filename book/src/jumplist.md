...
To help with quick navigation, fefix maintains a list of "jumps" called the jumplist.
Whenever you make a significant movement (see next section), fefix stores your selections from before the move as a jump.
